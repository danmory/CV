...
export default function AboutMe(){
    ...
    const bio = [
        ...
        'Frontend разработчик(React), понимающий и в случае необходимости способный написать серверную часть приложения.',
        'Понимаю, как используемые мною технологии работают "под капотом".',
        'Имеется знание компьютерных наук: алгоритмы и структуры данных, компьютерные сети, операционные системы, высшая математика.',
